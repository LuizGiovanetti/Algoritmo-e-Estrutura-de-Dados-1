...
Por último, os elementos da matriz esparsa devem ser lidos.

Output Format
Impressão da quantidade de elementos nulos.
*/
#include <stdio.h>
#include <string.h>
#include <math.h>
...
int conta_nulos(Spa_Mat *m)
{
    ...
    return (m->n_lin * m->n_col) - contador;
}
