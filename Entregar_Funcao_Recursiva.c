/*
Desafio:
Implementar uma função recursiva para lista duplamente encadeadaque faça uma das seguintes operações:
inserção na última posição, inserção ordenada ou remoção
*/
