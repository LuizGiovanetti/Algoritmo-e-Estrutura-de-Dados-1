...
Para a resolução desse exercício, utilize um TAD do tipo pilha estática para números inteiros,
podendo ser o código apresentado em sala de aula.
...
Input Format
A primeira linha apresenta um inteiro N, denotando o número de entradas na base decimal que serão testadas.
Nas próximas N linhas devem ser lidos os números na base decimal.
